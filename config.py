...
exp_configuration={
    ...
    403 :{
        ...
        # 'source_model_names':['ResNet50','resnet50_l2_eps0_1','DenseNet121','inception_v3'],
        # 'source_model_names':['ResNet50','resnet50_l2_eps0_1','DenseNet121','inception_v3'],
        ...
        # 普通模型
        'target_model_names':['vgg16'],
        # VIT模型
        # 'target_model_names':['resnet50_l2_eps0_1','vit_base_patch16_224','levit_384','convit_base','twins_svt_base','pit'],
        # DM
        'attack_methods': {'CFM-RDI-TI-MI': 'DM'},
        'number_of_v_samples':5,
        'number_of_si_scales':5,
        'visualize':False,
        ####################################
      ...
      604 :{
        ...
        'source_model_names':['ResNet50'],
        'target_model_names':['ResNet18'],
        'attack_methods': {'SI-RDI-TI-MI': 'SRTMI'},
        'number_of_v_samples':5,
        'number_of_si_scales':5,
        'visualize':False,
        ####################################
